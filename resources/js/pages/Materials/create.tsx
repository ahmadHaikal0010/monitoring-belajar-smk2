                    ...
                    <Card className="w-full p-6 border-none shadow-xl bg-card/50 backdrop-blur-sm">
                        <div className="grid gap-6">
                            ...
                            <div className="grid gap-2">
                                {(data.content_type === 'video' || data.content_type === 'document') && (
                                    <div className="space-y-2">
                                        <Label className="text-sm font-semibold">{data.content_type === 'video' ? 'File Video' : 'File PDF'}</Label>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Textarea 
                                    placeholder="Ringkasan penjelasan materi yang akan dipelajari siswa..." 
