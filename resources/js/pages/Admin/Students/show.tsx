...
export default function ShowStudent({ student }: Props) {
    setLayoutProps({
        breadcrumbs: [
            ...
            {
                title: 'Detail Siswa',
                href: admin.students.show.url(student.id),
            },
        ],
    });
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Informasi akademik dan data diri lengkap siswa.
                            </p>
                        </div>
                    </div>
                    <Button
                        ...
                        asChild
                    >
                        <Link href={admin.students.edit.url(student.id)}>
                            ...
                            <div className="px-6 pb-6">
                                ...
                                <div className="space-y-1 text-center lg:text-left">
                                    ...
                                    <div className="flex flex-wrap justify-center gap-2 pt-2 lg:justify-start">
                                        <Badge
                                            variant="secondary"
                                            className="border-none bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 text-[10px] font-bold"
                                        >
                                            SISWA
                                        </Badge>
                                        <Badge
                            ...
                            <section className="space-y-4">
                                ...
                                <div className="relative rounded-2xl border border-zinc-200/50 bg-muted/30 p-6 dark:border-zinc-800/50">
                                    <p className="text-base leading-relaxed text-foreground italic">
                                        {student.address ||
                                            'Tidak ada informasi alamat yang tersedia.'}
                                    </p>
                                </div>
                            </section>
                            ...
                            <div className="pt-4">
                                <div className="flex items-start gap-3 rounded-lg border border-blue-500/10 bg-blue-500/5 p-4">
                                    ...
                                    <p className="text-xs leading-relaxed text-muted-foreground">
                                        Akun siswa ini memiliki akses ke aplikasi mobile untuk monitoring kegiatan belajar. Perubahan data oleh admin akan langsung tercermin pada profil siswa di aplikasi mobile.
                                    </p>
                                </div>
                            </div>
                        </Card>
