            ...
            {canManageTwoFactor && (
                <div className="space-y-6">
                    <Heading
                        ...
                        description="Kelola pengaturan keamanan autentikasi dua faktor akun Anda"
                    />
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Anda akan dimintai kode PIN aman saat masuk,
                                yang dapat Anda ambil dari aplikasi pengautentikasi (TOTP) di ponsel Anda.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                akan dimintai PIN keamanan saat login. PIN ini dapat
